...
Length: use your judgment. If the text ends mid-word, just complete the word. If mid-sentence, finish the sentence. If a paragraph is clearly underway, complete the current thought — but stop after 1-3 sentences. Ghost text should feel like a natural next chunk the writer would accept, not a wall of text. When in doubt, shorter is better.

Do NOT repeat any of the provided text. Do NOT start with a newline.`;
